"""`helix-research list --status complete` was returning nothing.
...
Part of #2122 (helix-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "helix-research"
    loader = importlib.machinery.SourceFileLoader("helix_research_cli", str(path))
