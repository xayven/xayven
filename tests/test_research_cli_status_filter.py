"""`xayven-research list --status complete` was returning nothing.
...
Part of #2122 (xayven-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "xayven-research"
    loader = importlib.machinery.SourceFileLoader("xayven_research_cli", str(path))
