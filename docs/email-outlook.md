...
H E L I X email accounts currently use IMAP and SMTP with username/password
...
This is expected. H E L I X does not support Microsoft OAuth or Graph Mail yet,
