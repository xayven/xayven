"""scripts/_lib/cli.py — shared scaffolding for the `helix-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("helix-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/helix-foo`
...
VERSION = "0.1.0"  # bumped centrally; every helix-* CLI reports this
