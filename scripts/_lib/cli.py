"""scripts/_lib/cli.py — shared scaffolding for the `xayven-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("xayven-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/xayven-foo`
...
VERSION = "0.1.0"  # bumped centrally; every xayven-* CLI reports this
